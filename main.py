...
st.write(
    "전국 읍·면·동 인구 데이터를 바탕으로 시군구별 65세 이상 인구 비율을 계산하여 지도(단계구분도)로 시각화합니다."
)
...
# 3-3. 나이별 인구 합산 컬럼 생성 (총인구 및 65세 이상 인구)
...
st.info("💡 **안내:** 마우스를 시군구 위에 올리면 **시군구 이름, 시도, 중학교 3학년 인원(%)**이 표시됩니다.")
